...
public class Movement : MonoBehaviour {
	...
	void Update () {
        ...
        // forward/back
        transform.position += transform.forward * speed * -Input.GetAxis("L_YAxis_2");
        // left/right
        transform.position += transform.right * speed * Input.GetAxis("L_XAxis_2");
